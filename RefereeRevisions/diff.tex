...
%DIF ADD amt-2015-329-discussions-typeset_source-version4.tex   Mon Feb  1 16:30:42 2016
...
parameters and comparison between instruments can be significant different. }\DIFaddend (Russell and McCormick, 1989; Kovilakam et~al.,
...
\DIFdelbegin \DIFdel{the era of solar occultation measurements essentially came to an end
with SAGE III in 2006. However}\DIFdelend \DIFaddbegin \DIFadd{Furthermore}\DIFaddend , a~manifestation of SAGE III is planned
...
studied extensively and \DIFaddbegin \DIFadd{the conclusions are }\DIFaddend somewhat controversially (Bourassa et~al., 2012c,
...
input optical axis of the device. The ordinary light beam also
...
thickness of the crystal}\DIFaddend . However, it turns out that this wavelength
...
value across the image. The resulting images from the diffuse source
...
error and neglects any model and atmospheric state errors. The \DIFdelbegin \DIFdel{green
}\DIFdelend \DIFaddbegin \DIFadd{red
}\DIFaddend curve is the average 750\,\unit{nm} aerosol extinction profiles of the
...
instrument geometries, and yet the SAGE II, SAGE III and OSIRIS
