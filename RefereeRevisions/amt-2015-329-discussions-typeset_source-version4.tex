...
and particle size, no single measurement technique can fully determine the full range of aerosol properties unambiguously. In-situ balloon observations continue to be used and have
...
parameters and comparison between instruments can be significant different. (Russell and McCormick, 1989; Kovilakam et~al.,
...
agree relatively well, generally within 15\%, with SAGE II and SAGE III occultation
...
studied extensively and the conclusions are somewhat controversially (Bourassa et~al., 2012c,
...
possible basic layouts: the telecentric or the telescopic system. The telecentric system uses a layout that removes perspective from the image and object plane and the telescoptic system uses a telescope as the front end optics. This
...
thickness of the crystal. However, it turns out that this wavelength
dependent change is less than a micron for the current ALI design and is considered negligible.
...
immediately obtained with the same exposure time. For the calibration images an average signal to noise ratio of 40 was noted.
...
error and neglects any model and atmospheric state errors. The red
