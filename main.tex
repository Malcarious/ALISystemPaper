...
\includegraphics[width=0.5\textwidth]{./Images/BeforeAfterImage.pdf}
    \caption{Comparison of the same image, image number 212 at 750~nm. The upper panel is the level 0 data and the lower panel is level 1 data.}
